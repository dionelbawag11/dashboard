...
class Am_Paysystem_CcDemo extends Am_Paysystem_CreditCard implements Am_Paysystem_TokenPayment
{
    ...
    {
        return ['visa' => 'Visa', 'mastercard' => 'MasterCard'];
    }
    ...
    {
        $transaction = new Am_Paysystem_Transaction_CcDemo_Refund($this, $payment->getInvoice(), new Am_Mvc_Request(['receipt_id'=>'rr']), false);
