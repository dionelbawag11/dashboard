...
class Am_Theme_Redi extends Am_Theme_Default
{
    protected $publicWithVars = ['css/theme.css'];
    protected $formThemeClassUser = 'Am_Form_Theme_Redi';
    ...
    public function initSetupForm(Am_Form_Setup_Theme $form)
    {
        $this->getDi()->view->headLink()
            ...
            ->appendStylesheet('https://fonts.googleapis.com/css?family=Karla:400,700')
            ->appendStylesheet('https://fonts.googleapis.com/css?family=Urbanist:400,700')
            ->appendStylesheet('https://fonts.googleapis.com/css?family=Oxanium:400;700');
...
CUT
    ...
    jQuery(document).on('change', '[name$=font_header_size]', function(){
        $('#font-header-preview').css({fontSize: $(this).val() + 'px'});
    });
    
    // Trigger all change events on page load to apply initial values
    jQuery(function(){
        $('[name$=font_family]').change();
        $('[name$=font_size]').change();
        $('[name$=font_header_size]').change();
    });
    CUT
            );
...
CUT
        ...
        foreach ($sm as $id => $url) {
            ...
            $g = $fs->addGroup(null, ['class' => 'am-row-highlight', 'id' => 'sm-item-' . $id])
...
CUT
        ...
        $fs = $form->addAdvFieldset(null, ['id' => 'sct-active-subs'])
            ->setLabel('Active Subscription');

        // $gr = $fs->addGroup()
        //     ->setLabel(___("Title font size"));
        // $gr->setSeparator(' ');
        // $gr->addText('font_header_size', ['size' => 3]);
        // $gr->addHtml()->setHtml('px');

        // $fs->addHtml()
        //     ->setHtml(<<<CUT
        // <div id="font-header-preview" style="opacity:.7; white-space: nowrap; overflow: hidden; text-overflow:ellipsis">Almost before we knew it, we had left the ground.</div>
        // CUT
        //     );


        $this->addElementColor($fs, 'view_color', "View Button Color\n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>');

        $this->addElementColor($fs, 'subscription_tab_color', "Subscription Button Color\n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>');

        $this->addElementColor($fs, 'try_color', "Active Subscriptions Courses\n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>');

        $gr = $fs->addGroup()
            ->setLabel(___("Active Subscriptions Layout\n" . 'will not work if Single Column is activated'));
        $gr->addAdvRadio('left_right')
            ->loadOptions([
                'left' => ___('Left Side'),
                'right' => ___('Right Side')
            ]);

        $gr = $fs->addGroup()
            ->setLabel(___("Product expiry filter"));
        $gr->addAdvRadio('show_hide_expiry')
            ->loadOptions([
                'show_expiry' => ___('Show'),
                'hide_expiry' => ___('Hide')
            ]);

        $gr = $fs->addGroup()
            ->setLabel(___("Product next bill filter"));
        $gr->addAdvRadio('show_hide_nextbill')
            ->loadOptions([
                'show_nextbill' => ___('Show'),
                'hide_nextbill' => ___('Hide')

            ]);

        $gr = $fs->addGroup()
            ->setLabel(___("Product lifetime filter"));
        $gr->addAdvRadio('show_hide_lifetime')
            ->loadOptions([
                'show_lifetime' => ___('Show'),
                'hide_lifetime' => ___('Hide')
            ]);

        $fs = $form->addAdvFieldset(null, ['id' => 'sct-faq'])
            ->setLabel('FAQ');

        $this->addElementColor($fs, 'faq_bg', "FAQ background color\n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>');
        $this->addElementColor($fs, 'faq_text', "Title color\n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>');

        $this->addElementColor($fs, 'faq_bg_active', "FAQ Active background color \n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>');
        $this->addElementColor($fs, 'faq_active_text', "Active text color\n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>');
        $this->addElementColor($fs, 'faq_active_title_text', "Active title text color\n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>');

        $fs = $form->addAdvFieldset(null, ['id' => 'sct-cart'])
            ->setLabel('Cart');

        $this->addElementColor($fs, 'hover_cart', "Popover Hover Content\n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>');
...
CUT
        ...
        $this->addElementColor($form, 'header_top', "Header Top Background Color\n" .
        ...
        $this->addElementColor($form, 'header_bg_color', "Main Header Background Color\n" .
            'you can use any valid <a href="http://www.w3schools.com/html/html_colors.asp" class="link" target="_blank" rel="noreferrer">HTML color</a>, you can find useful color palette <a href="http://www.w3schools.com/TAGS/ref_colornames.asp" class="link" target="_blank" rel="noreferrer">here</a>, leave it empty if you do not want to have separate background for header', null, ['class' => 'am-row-highlight']);
...
CUT
    ...
    function addElementColor($form, $name, $label, $id = null, $attr = [])
    {
        ...
        foreach (['#f1f5f9', '#dee7ec', '#ffebcd', '#ff8a80', '#ea80fc', '#d1c4e9', '#e3f2fd', '#bbdefb', '#0079d1', '#b2dfdb', '#e6ee9c', '#c8e6c9', '#4caf50', '#bcaaa4', '#212121', '#263238', '#2a333c'] as $color) {
            $gr->addHtml()
    ...
    function changeText($form, $name, $label, $id = null, $attr = [])
    {
        $gr = $form->addGroup(null, $attr)
            ->setLabel($label);
        $gr->setSeparator(' ');
    ...
    function printLayoutHead(Am_View $view)
    {
        ...
        if ($this->getConfig('font_family') == self::F_KARLA) {
            $view->headLink()->appendStylesheet('https://fonts.googleapis.com/css?family=Karla:400,700');
        }
        if ($this->getConfig('font_family') == self::F_URBANIST) {
            $view->headLink()->appendStylesheet('https://fonts.googleapis.com/css?family=Urbanist:400,700');
        }
        if ($this->getConfig('font_family') == self::F_OXANIUM) {
            $view->headLink()->appendStylesheet('https://fonts.googleapis.com/css?family=Oxanium:400,700');
        }
...
CUT
        ...
        if ($this->getConfig('left_right') == 'left') {
            $view->headStyle()->appendStyle(<<<CUT
        ...
        } elseif ($this->getConfig('left_right') == 'right') {
            $view->headStyle()->appendStyle(<<<CUT
        @media all and (min-width: 750px) {
          .am-layout-two-coll .am-coll-left {
            float: left;
        ...
        if ($this->getConfig('show_hide_expiry') == 'hide_expiry') {
            $view->headStyle()->appendStyle(<<<CUT
            #expires-tab{
                display: none;
            }
        ...
        if ($this->getConfig('show_hide_nextbill') == 'hide_nextbill') {
            $view->headStyle()->appendStyle(<<<CUT
            #next-bill-tab{
                display: none;
            }
        ...
        if ($this->getConfig('show_hide_lifetime') == 'hide_lifetime') {
            $view->headStyle()->appendStyle(<<<CUT
            #lifetime-tab{
                display: none;
            }
        ...
        if ($this->getConfig('identity_align') == 'left') {
            $view->headStyle()->appendStyle(<<<CUT
...
CUT
    ...
    function getFontOptions()
    {
        return [
            ...
            self::F_JOST => 'Jost',
            self::F_KARLA => 'Karla',
            self::F_URBANIST => 'Urbanist',
            self::F_OXANIUM => 'Oxanium',
        ];
    }
...
class Am_Form_Theme_Redi extends Am_Form_Theme_Default
{
