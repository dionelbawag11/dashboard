<?php
 return array (
  ...
  ' day' => ' day',
  ' hour' => ' hour',
  ' in total sales amount ' => ' in total sales amount ',
...
you can create new pages %shere%s' => 'Access Forbidden (403)
%sthis page will be public and do not require any login/password%s
...
Default value is 1 one hour)',
  ...
  'Add Login/Logout link based on user authentication status' => 'Add Login/Logout link based on user authentication status',
...
to admin once payment is refunded',
  ...
  'Affiliate Already Has Commission With User' => 'Affiliate Already Has Commission With User',
...
use only letters or numbers like terms-of-use or privacy-policy',
  ...
  'All Cache data is cleared' => 'All Cache data is cleared',
...
in user area',
  ...
  'Allow to exchange credits for more than one copy of product
By default aMember allow to purchase only one copy of a product using credits.
With that option enabled user will be able to add the same product more then once' => 'Allow to exchange credits for more than one copy of product
By default aMember allow to purchase only one copy of a product using credits.
With that option enabled user will be able to add the same product more then once',
  'Allow to transfer credits between users
            When enabled, user will be able to send credits to another user
            User will be able to transfer credits with no expiration period.' => 'Allow to transfer credits between users
            When enabled, user will be able to send credits to another user
            User will be able to transfer credits with no expiration period.',
  'Allow use Cart only to Registered Users' => 'Allow use Cart only to Registered Users',
  'Allowed Domains
to set CORS headers for API requests' => 'Allowed Domains
to set CORS headers for API requests',
...
Leave empty if you want to use all buckets',
  ...
  'Amend Access Permissions' => 'Amend Access Permissions',
  'Amend Product Requirements' => 'Amend Product Requirements',
  'Amend Requirements' => 'Amend Requirements',
...
<ul>
  ...
  'Awaiting Approval Listings' => 'Awaiting Approval Listings',
  'BEGIN' => 'BEGIN',
  'Back to  Category Types' => 'Back to  Category Types',
...
by default commission calculated from amounts before tax',
  ...
  'Calculate and add tier commissions
...
for admin reference',
  ...
  'Cancellations (without upgrade)' => 'Cancellations (without upgrade)',
  'Cart View' => 'Cart View',
  'Catalogue Layout
...
all categories is included by default',
  'Category Type Title' => 'Category Type Title',
  'Category Types' => 'Category Types',
  'Change Admin Password Notification
send email to admin after password change' => 'Change Admin Password Notification
...
send email to user after password change',
  ...
  'Clean up v6 Database' => 'Clean up v6 Database',
  'Clean up...' => 'Clean up...',
  ...
  'Closed Captions (WebVTT file, .vtt)
file must be in VTT format, used for HTML5 player, applicable only for video files. You can easily convert SRT to WebVTT using an online converter such as %ssrt2vtt%s.' => 'Closed Captions (WebVTT file, .vtt)
file must be in VTT format, used for HTML5 player, applicable only for video files. You can easily convert SRT to WebVTT using an online converter such as %ssrt2vtt%s.',
...
For admin use only. Won\'t be displayed anywhere',
  'Comment
affiliate will see it in his report' => 'Comment
...
calculated for first customer invoice only',
  'Commission for Rebills
apply to subsequent payments within same auto recurring subscription' => 'Commission for Rebills
apply to subsequent payments within same auto recurring subscription',
...
date range when coupon can be used',
  'Dates can be in the following formats' => 'Dates can be in the following formats',
  ...
  'Default Forbidden Page' => 'Default Forbidden Page',
  'Default Image' => 'Default Image',
  'Default Not Found Page' => 'Default Not Found Page',
  'Default SMS Transport' => 'Default SMS Transport',
...
(that is default value for inputs, not SQL DEFAULT)',
  ...
  'Delay Between Reties
        delay in hours' => 'Delay Between Reties
        delay in hours',
  'Delay Payout (days)
number of days that should go through before commission is included to payout report' => 'Delay Payout (days)
number of days that should go through before commission is included to payout report',
  ...
  'Denied Notification to Affiliate' => 'Denied Notification to Affiliate',
  'Deny' => 'Deny',
  'Description
...
for internal use',
  ...
  'Disallow ordering of this product if user ha' => 'Disallow ordering of this product if user ha',
...
use existing products for demo records',
  ...
  'Do not require login to access listings' => 'Do not require login to access listings',
  ...
  'Do you really want to re send this Email?' => 'Do you really want to re send this Email?',
...
make it public',
  ...
  'Domains
list of domains where you want to use shopping cart buttons' => 'Domains
list of domains where you want to use shopping cart buttons',
  ...
  'Due Date' => 'Due Date',
  'Due date has been changed!' => 'Due date has been changed!',
  'Duration:' => 'Duration:',
...
used to display name of sender in outgoing e-mails',
  ...
  'Edit Categories (%s)' => 'Edit Categories (%s)',
...
PLEASE DO NOT CHANGE if emailing from aMember works',
  ...
  'Email confirmation message that will be sent customer
e-mail confirmation should be enabled for oauth-registration and profile forms
at aMember CP -> Forms Editor -> Edit, click "configure" on E-Mail brick' => 'Email confirmation message that will be sent customer
e-mail confirmation should be enabled for oauth-registration and profile forms
...
allow use coupons on shopping cart checkout page',
  ...
  'Events
to include to widget, leave it empty to include all events' => 'Events
to include to widget, leave it empty to include all events',
  'Every %s' => 'Every %s',
...
enter cost of 1 (one) %s',
  ...
  'Exclude Products
do not apply coupons to selected products' => 'Exclude Products
...
for dispaying on signup and profile editing screen (for user)',
  ...
  'Field Placeholder
specifies a short hint that describes the expected value of an input field' => 'Field Placeholder
...
price of first period of subscription',
  'First Tax' => 'First Tax',
  'First Time Affiliate Sale' => 'First Time Affiliate Sale',
...
in user area',
  'Hide from Dashboard' => 'Hide from Dashboard',
  'Hide from Dashboard
...
How many simultaneous bindings for license may exists (default - 1)',
  ...
  'Invoice Payment ID (Internal Id)' => 'Invoice Payment ID (Internal Id)',
  'Invoice Refund ID (Internal Id)' => 'Invoice Refund ID (Internal Id)',
...
* subscription expiration notices',
  ...
  'Last Signin (Date/Time)' => 'Last Signin (Date/Time)',
  ...
  'Layout
use placeholder %content% for email output' => 'Layout
use placeholder %content% for email output',
  'Length of field name must be from %d to %d' => 'Length of field name must be from %d to %d',
...
used to represent product in Active Subscriptions widget on user dashboard, leave empty to display product without link. This link will not become automatically protected.',
  ...
  'Link URL' => 'Link URL',
  'List Unsubscribed Notification' => 'List Unsubscribed Notification',
  'List View' => 'List View',
  'Listing Image max size in Kb' => 'Listing Image max size in Kb',
  'Listing Image max width in pixels' => 'Listing Image max width in pixels',
  'Live Preview' => 'Live Preview',
  'Live Products' => 'Live Products',
  'Loading Plugins List…' => 'Loading Plugins List…',
  ...
  'MailGun' => 'MailGun',
  'MailGun Account' => 'MailGun Account',
  'MailGun Domain' => 'MailGun Domain',
  'MailGun Private API Key' => 'MailGun Private API Key',
  'Manage' => 'Manage',
  'Manage Additional User Fields' => 'Manage Additional User Fields',
  'Manage Applications' => 'Manage Applications',
  'Manage Categories: %s' => 'Manage Categories: %s',
...
minimal commission amount earned by affiliate to include it to payout report',
  'Mobile Area Code' => 'Mobile Area Code',
...
First and Last name',
  ...
  'New Custom Form Campaign' => 'New Custom Form Campaign',
  'New Default Form Campaign' => 'New Default Form Campaign',
  ...
  'New Sale notification to seller' => 'New Sale notification to seller',
...
aMember will email an autoresponder to user each time user create new ticket',
  'New listing notification to admin' => 'New listing notification to admin',
  'Next Day' => 'Next Day',
  'Next Hour' => 'Next Hour',
...
leave empty if you want to redirect to default \'No access\' page',
  ...
  'Note' => 'Note',
  'Notify Admin when User Get Product' => 'Notify Admin when User Get Product',
  'Notify user when credits transferred to his account' => 'Notify user when credits transferred to his account',
...
for all instances (default - 0)',
  ...
  'Number of Payment in Invoice' => 'Number of Payment in Invoice',
  'Number of Payments to display' => 'Number of Payments to display',
  'Number of Refunds to display' => 'Number of Refunds to display',
  'Number of Retries
        How many times aЬember will try to resend message' => 'Number of Retries
        How many times aЬember will try to resend message',
  ...
  'Only a-zA-Z0-9_- is allowed' => 'Only a-zA-Z0-9_- is allowed',
...
it is necessary to validate your reCaptcha config before enable this option, otherwise you can lock himself from admin interface',
  'Please enable at least one SMS transport plugin' => 'Please enable at least one SMS transport plugin',
...
a new password via email.',
  'Please login into your amember.com account to continue' => 'Please login into your amember.com account to continue',
...
path where you have uploaded your public.key',
  ...
  'Purely random usernames
if username is generated, do not use email address or name for generation' => 'Purely random usernames
...
will occur at the Second Price',
  ...
  'Rebills (Remaining in Current Month)' => 'Rebills (Remaining in Current Month)',
...
Allows you to set up sequential or parallel subscription periods. Subscriptions from the same group will begin at the end of subscriptions from the same group. Subscriptions from different groups can run side-by-side',
  ...
  'Reports' => 'Reports',
  'Request to confirm sale notification
            will be sent to customer each four starting from three hours of confirm time frame expiration' => 'Request to confirm sale notification
            will be sent to customer each four starting from three hours of confirm time frame expiration',
  'Request to send item notification
            will be sent to seller each four starting from three hours of delivery time frame expiration' => 'Request to send item notification
            will be sent to seller each four starting from three hours of delivery time frame expiration',
...
the following periods of subscription',
  'Secret Code
if form is not chosen as default, this code
...
Credit Card Rebill Stats will be sent to Admin daily. It works for payment processors like Authorize.Net and PayFlow Pro only',
  ...
  'Send E-Mail to %s User(s)' => 'Send E-Mail to %s User(s)',
...
Username of existing user to send test email',
  'Send Unsubscribe Confirmation to user
Send email to user on unsubscribe' => 'Send Unsubscribe Confirmation to user
Send email to user on unsubscribe',
  ...
  'Set Product Requirements' => 'Set Product Requirements',
...
You can use the following placeholders %name_f%, %name_l% it will be expanded to first and last name of admin in operation',
  'Signup Form
will be used if user is not logged-in. This form is used only for user registration, so all bricks related to purchase (Product, Payment System) will be automatically removed form it.' => 'Signup Form
will be used if user is not logged-in. This form is used only for user registration, so all bricks related to purchase (Product, Payment System) will be automatically removed form it.',
...
This settings has no effect for recurring subscriptions',
  ...
  'Surcharge' => 'Surcharge',
  'Surcharge
to be additionally charged when customer moves [From]->[To] plan. aMember does not charge First Price on upgrade, use Surcharge instead. You can use negative Surcharge in case of downgrade.' => 'Surcharge
...
move information to',
  ...
  'Tax First Name' => 'Tax First Name',
  'Tax Group Name
for your reference' => 'Tax Group Name
for your reference',
  'Tax Last Name' => 'Tax Last Name',
  'Tax State' => 'Tax State',
  'Tax Street' => 'Tax Street',
  'Tax Street2' => 'Tax Street2',
  'Tax Zip' => 'Tax Zip',
...
if none specified, rule works for all products',
  ...
  'This user is Permanently Locked.' => 'This user is Permanently Locked.',
  ...
  'Timeframe to complete sale in hours
        How many hours buyer have to confirm  sale. After that period, transaction will be marked as expired
        if seller didn\'t deliver item. Credits will not be returned in this case
        ' => 'Timeframe to complete sale in hours
        How many hours buyer have to confirm  sale. After that period, transaction will be marked as expired
        if seller didn\'t deliver item. Credits will not be returned in this case
        ',
  'Timeframe to deliver item in hours
        How many hours seller have to deliver item. After that period, transaction will be reverted automatically
        if seller didn\'t deliver item
        ' => 'Timeframe to deliver item in hours
        How many hours seller have to deliver item. After that period, transaction will be reverted automatically
        if seller didn\'t deliver item
        ',
...
displayed to customers',
  ...
  'To order this product user must have' => 'To order this product user must have',
...
when user uses coupon, it will be checked that user has at least one of the following subscriptions',
  ...
  'Token' => 'Token',
  'Token Expire in days
        default lifetime' => 'Token Expire in days
        default lifetime',
  'Top %d Affiliates' => 'Top %d Affiliates',
  'Top Affiliates' => 'Top Affiliates',
  'Total Paid' => 'Total Paid',
  'Total Spent' => 'Total Spent',
  'Total revenue: %s' => 'Total revenue: %s',
  'Total to Pay' => 'Total to Pay',
  'Trace' => 'Trace',
  'Traditional .htpasswd' => 'Traditional .htpasswd',
  'Transaction status changed notification to Buyer' => 'Transaction status changed notification to Buyer',
  'Transaction status changed notification to Seller' => 'Transaction status changed notification to Seller',
  'Transactions Log' => 'Transactions Log',
  'Translation' => 'Translation',
  'Translations' => 'Translations',
  'Try to resend Failed Messages
            If aMember wasn\'t able to send message for some reason,
            it will try to send it again later' => 'Try to resend Failed Messages
            If aMember wasn\'t able to send message for some reason,
            it will try to send it again later',
  ...
  'Type to Filter by Title or Description…' => 'Type to Filter by Title or Description…',
...
keep it empty to use any products',
  'Use this %slink%s to delete data from aMember v6 database and use clean database for import' => 'Use this %slink%s to delete data from aMember v6 database and use clean database for import',
  'Used For' => 'Used For',
  'Used Rules' => 'Used Rules',
  'Used coupon' => 'Used coupon',
  'User Access' => 'User Access',
  'User Can Close Tickets' => 'User Can Close Tickets',
...
how many times a coupon code can be used by customer',
  ...
  'User will see this item in menu only if has access to this link' => 'User will see this item in menu only if has access to this link',
...
audio formats that supported by HTML5' => 'Video/Audio File
(max upload size %s)
You can use this feature only for video and
audio formats that supported by HTML5',
  ...
  'WARNING! Once [Merge] button clicked, all invoices, payments, logs and other information regarding \'Source User\' will be moved to the \'Target User\' account. \'Source User\' account will be deleted. There is no way to undo this operation!' => 'WARNING! Once [Merge] button clicked, all invoices, payments, logs and other information regarding \'Source User\' will be moved to the \'Target User\' account. \'Source User\' account will be deleted. There is no way to undo this operation!',
  'Warnings' => 'Warnings',
  'Watchers
...
notify the following admins about new messages in this category',
  ...
  'You can use this tool to clear all cache data.' => 'You can use this tool to clear all cache data.',
  ...
  'You have OTP authentication enabled, but several forms doesn\'t require Email  validation. Please %scheck%s all Signup/Profile forms and make sure that you have enabled Email  validation' => 'You have OTP authentication enabled, but several forms doesn\'t require Email  validation. Please %scheck%s all Signup/Profile forms and make sure that you have enabled Email  validation',
...
enter your current password in order to edit admin record',
  ...
  'aMember Add-Ons' => 'aMember Add-Ons',
...
and template filename must start with [signup]',
  ...
  'after' => 'after',
  'all requests will be added to %sLogs%s, useful if something is going wrong' => 'all requests will be added to %sLogs%s, useful if something is going wrong',
  'allow max' => 'allow max',
  ...
  'commission earned in given period' => 'commission earned in given period',
  ...
  'fix' => 'fix',
  'forecast' => 'forecast',
  'hide canceled by upgrade invoices' => 'hide canceled by upgrade invoices',
  ...
  'hours' => 'hours',
  'if code is present, products from this category will be hidden in shopping cart and this code is required to see these products. This code should be appended to url as GET parameter c ie.:' => 'if code is present, products from this category will be hidden in shopping cart and this code is required to see these products. This code should be appended to url as GET parameter c ie.:',
  'immediately after any payment' => 'immediately after any payment',
  'immediately after first payment in subscription' => 'immediately after first payment in subscription',
  ...
  'immediately after subsequent payment in subscription' => 'immediately after subsequent payment in subscription',
  ...
  'must be equal or greater than 0.0' => 'must be equal or greater than 0.0',
  ...
  'rem. days of the month' => 'rem. days of the month',
  'replace' => 'replace',
  'restoring all users. %d users restored' => 'restoring all users. %d users restored',
  'send this message even if customer has cancelled recurring subscription for matched product' => 'send this message even if customer has cancelled recurring subscription for matched product',
  'sending' => 'sending',
  ...
  'version' => 'version',
  'void' => 'void',
  'without upgrade' => 'without upgrade',
  'yes' => 'yes',
  'yesterday' => 'yesterday',
);
