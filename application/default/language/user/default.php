<?php
 return array (
  ...
  '%1$s refund of %2$s issued via Paddle for invoice #%3$s.' => '%1$s refund of %2$s issued via Paddle for invoice #%3$s.',
  ...
  '%d triggers&hellip;' => '%d triggers&hellip;',
...
',
  ...
  '%s credits were received  from user %s' => '%s credits were received  from user %s',
  '%s credits were transferred  to user %s' => '%s credits were transferred  to user %s',
  '%s database and tables prefix' => '%s database and tables prefix',
  '%s has marked transaction as completed' => '%s has marked transaction as completed',
  ...
  '%sClick here%s to getAuthorization Code (link will be opened in new window)' => '%sClick here%s to getAuthorization Code (link will be opened in new window)',
...
Set it to be lifetime',
  ...
  'Access Token
        <a href=\'https://developers.facebook.com/docs/marketing-api/conversions-api/get-started#via-events-manager\'>Instructions</a>' => 'Access Token
        <a href=\'https://developers.facebook.com/docs/marketing-api/conversions-api/get-started#via-events-manager\'>Instructions</a>',
  ...
  'Access token is set. Use this %slink%s to delete it' => 'Access token is set. Use this %slink%s to delete it',
  'Accound SID' => 'Accound SID',
  'Account' => 'Account',
...
first and last name',
  ...
  'Active Users by Product Categories' => 'Active Users by Product Categories',
  ...
  'Add Pixel code to aMember Pages
        that option should be disabled if you already
        did add  pixel code through wordpress
        theme integration or manually' => 'Add Pixel code to aMember Pages
        that option should be disabled if you already
        did add  pixel code through wordpress
        theme integration or manually',
...
this user always will be assigned as 2-tier affiliate for all affiliates',
  ...
  'Affiliate Payout - Paxum E-Mail address' => 'Affiliate Payout - Paxum E-Mail address',
  ...
  'Affiliate Payout - UPI address' => 'Affiliate Payout - UPI address',
...
By default instant commissions will be enabled only if you enable this in affiliate profile',
  ...
  'Allow for customer to change item quantiry' => 'Allow for customer to change item quantiry',
...
Pakistan, Romania, Serbia and Montenegro, Ukraine, or Vietnam',
  ...
  'Allow to access marketplace' => 'Allow to access marketplace',
  ...
  'Allow to post listings' => 'Allow to post listings',
...
with whole directory - useful to print it',
  'Allowed MIME types
keep empty if there is not any restrictions' => 'Allowed MIME types
...
such as fixed land line, mobile, VoIP, and invalid phone numbers',
  ...
  'Amount is incorrect' => 'Amount is incorrect',
  'Amount of Credits to Transfer' => 'Amount of Credits to Transfer',
  'Amount of Rebills' => 'Amount of Rebills',
...
apply discount to recurring rebills',
  ...
  'Attempt to charge existing customer without redirect
        aMember will try to charge customer by previous subscription first.
        If fails, user will be sent to ccBill
        ' => 'Attempt to charge existing customer without redirect
        aMember will try to charge customer by previous subscription first.
        If fails, user will be sent to ccBill
        ',
  ...
  'Authorization code is empty' => 'Authorization code is empty',
...
%s accounts against any aMember activity',
  ...
  'Baremetrics API Key
        you can get it here: https://app.baremetrics.com/settings/api' => 'Baremetrics API Key
        you can get it here: https://app.baremetrics.com/settings/api',
...
new coupons for affiliate will be generated in this batch',
  'Before Rebill Email
            Message will be sent before rebill date' => 'Before Rebill Email
...
you can create field for birthday %shere%s, it should have date type',
  ...
  'Buymeacoffee ID' => 'Buymeacoffee ID',
  ...
  'Cancel Feedback: can see cancel reason' => 'Cancel Feedback: can see cancel reason',
  'Cancel Feedback: can see list' => 'Cancel Feedback: can see list',
  'Cancel Product Title' => 'Cancel Product Title',
  'Cancel Subscription' => 'Cancel Subscription',
  'Cancel Subscripton' => 'Cancel Subscripton',
  'Cancel future recurring payments' => 'Cancel future recurring payments',
  'Cancel the following product(s) on Signup' => 'Cancel the following product(s) on Signup',
...
cardholder first and last name, exactly as on the card',
  ...
  'Categories
keep empty to report all categories' => 'Categories
keep empty to report all categories',
  ...
  'Category typoe is not set' => 'Category typoe is not set',
  'Center' => 'Center',
...
You can choose same admin several times to balance tickets accordingly',
  ...
  'Code was already sent' => 'Code was already sent',
...
disregard subsequent recurring payments',
  ...
  'Contabo  storage is not configured' => 'Contabo  storage is not configured',
...
Useful for invoices with non-Latin symbols when there is a problem with displaying such symbols in the PDF invoice.Please upload .ttf file only.',
  'Custom CSS to be included on paqyment page' => 'Custom CSS to be included on paqyment page',
...
Useful for invoices with non-Latin symbols when there is a problem with displaying such symbols in the PDF invoice. Please upload .ttf file only.',
  ...
  'Data key is empty. Unable to rebill' => 'Data key is empty. Unable to rebill',
...
Plugin will decline all payment attempts',
  ...
  'Declined: Funds confirmation failed' => 'Declined: Funds confirmation failed',
  'Declined: Verification was not passed' => 'Declined: Verification was not passed',
...
Leave unchecked if you want newsletter default to be checked',
  ...
  'Delivery Timeframe, hours' => 'Delivery Timeframe, hours',
...
in case of user logged in via IP',
  ...
  'Disable Single Login Session Protection
if user has active subscription to this product' => 'Disable Single Login Session Protection
...
in case of several discount rules is applicable to same invoice - max discount will be used' => 'Discount
this discount will be applied to each item that present in condition
In case of discount is more than total of item - discount will be completely ignored
if user use coupon with purchase - max discount will be used,
...
',
  ...
  'Disregard' => 'Disregard',
  'Disregard Behavior
what to do with invoice once user click Disregard link' => 'Disregard Behavior
what to do with invoice once user click Disregard link',
  'Do Import' => 'Do Import',
  'Do Not Show Login Form' => 'Do Not Show Login Form',
...
will be sent after last payment',
  ...
  'Email Address
to send test message' => 'Email Address
...
aMember will email a notification to user each time admin responds to a user ticket, user can reply to this message from his mail agent directly, response will be added to ticket automatically',
  ...
  'Email is empty. Can\'t continue' => 'Email is empty. Can\'t continue',
  ...
  'Enable 2FA Auth via email with OTP' => 'Enable 2FA Auth via email with OTP',
  'Enable 3SD Support
        You need to obtain an account with https://paay.co' => 'Enable 3SD Support
        You need to obtain an account with https://paay.co',
  'Enable API Requests Logging' => 'Enable API Requests Logging',
  'Enable Cancellation Discounts
        When user attempts  to cancel, plugin checks whenever discount is available for subscription
        If there is a discount, user will be offered to pay lower price.
        Discount should be already configured for subscription in ccBill
        ' => 'Enable Cancellation Discounts
        When user attempts  to cancel, plugin checks whenever discount is available for subscription
        If there is a discount, user will be offered to pay lower price.
        Discount should be already configured for subscription in ccBill
  ...
  'Enable Funds Conformation' => 'Enable Funds Conformation',
...
',
  ...
  'Enable integration for these products
            keep empty to enable it for all products' => 'Enable integration for these products
            keep empty to enable it for all products',
  'Enable quantity in listings' => 'Enable quantity in listings',
  ...
  'Enter it  in the form below in order to continue' => 'Enter it  in the form below in order to continue',
...
keep empty to report all files',
  ...
  'Files located on Contabo storage. (Warning: Your buckets should not contain letters in uppercase in its name)' => 'Files located on Contabo storage. (Warning: Your buckets should not contain letters in uppercase in its name)',
  ...
  'Files located on StackPath storage. (Warning: Your buckets should not contain letters in uppercase in its name)' => 'Files located on StackPath storage. (Warning: Your buckets should not contain letters in uppercase in its name)',
  ...
  'Flat amount product
will be used if send flat amount payment link,
leave empty to charge flat amount without product' => 'Flat amount product
will be used if send flat amount payment link,
leave empty to charge flat amount without product',
  ...
  'Follow the link to reset Chartmogul ID\'s' => 'Follow the link to reset Chartmogul ID\'s',
...
this content will be included to footer',
  ...
  'Friend Last Name' => 'Friend Last Name',
  ...
  'Get/Update  Payment Token' => 'Get/Update  Payment Token',
...
empty or 0 - without limit',
  ...
  'Got Error from Aweber API: [%s] : %s' => 'Got Error from Aweber API: [%s] : %s',
  'Got a coupon? %sapply here%s' => 'Got a coupon? %sapply here%s',
...
in this list as "Primary"',
  ...
  'Has active recurring invoice with products' => 'Has active recurring invoice with products',
  ...
  'Has not active recurring invoice with products' => 'Has not active recurring invoice with products',
...
what you want to display in identity block',
  ...
  'In order to perform this action you will be asked to verify your email.
        We will send onetime verification pin-code to your email. Click button below to start verification process' => 'In order to perform this action you will be asked to verify your email.
        We will send onetime verification pin-code to your email. Click button below to start verification process',
  'Inactivity Days
...
email will contain this sentence',
  ...
  'Instructions by seller' => 'Instructions by seller',
  ...
  'Intro Text on Capture Feedback Form' => 'Intro Text on Capture Feedback Form',
  ...
  'Invite' => 'Invite',
  'Invite Accepted to Admin' => 'Invite Accepted to Admin',
  'Invite Accepted to User' => 'Invite Accepted to User',
...
This text will be included at bottom to PDF Invoice. You can use all user specific placeholders here eg. %user.login%, %user.name_f%, %user.name_l% etc.',
  ...
  'Invoice ID is empty' => 'Invoice ID is empty',
  ...
  'Invoice Number: ' => 'Invoice Number: ',
  'Invoice Payment System ID' => 'Invoice Payment System ID',
  ...
  'Invoice Upgrades' => 'Invoice Upgrades',
...
check it if you want to gift subscription on this product',
  ...
  'Item' => 'Item',
  'Item ID is empty' => 'Item ID is empty',
...
it will be injected on signup form',
  ...
  'Keep User Subscribed' => 'Keep User Subscribed',
...
keep it empty for unlimited',
  'Limit ability to change quantity for these items' => 'Limit ability to change quantity for these items',
...
alternative template for list page',
  'List View Toggle' => 'List View Toggle',
  ...
  'Listing ID is empty in request' => 'Listing ID is empty in request',
  'Listing Title' => 'Listing Title',
  'Listing Type' => 'Listing Type',
  'Listing status can\'t be changed' => 'Listing status can\'t be changed',
  'Listing was created by another user!' => 'Listing was created by another user!',
  'Listings' => 'Listings',
  'Lists
...
Some scripts have special group for this situations: \'Unregistered\' or \'Guest\'',
  ...
  'Login Type (ADMIN or USER)' => 'Login Type (ADMIN or USER)',
...
API key can be obtained from Integrations page when you are logged into MailerLite application',
  ...
  'Manual Payment Required Email
            Message will be sent on rebill date and later according to Reattempt on failure settings' => 'Manual Payment Required Email
  ...
  'Marketplace Item Receipt' => 'Marketplace Item Receipt',
  'Marketplace order revert# ' => 'Marketplace order revert# ',
...
(not to be confused with the Control Panel username)',
  ...
  'Membership Id is empty' => 'Membership Id is empty',
...
Use demo for testing',
  ...
  'Merchant’s Service password' => 'Merchant’s Service password',
  'Merchant’s Service username' => 'Merchant’s Service username',
  'Merchant’s website ID' => 'Merchant’s website ID',
  'Message' => 'Message',
  'Message
...
keep it empty if there is not any limit',
  ...
  'Missing necessary parameters' => 'Missing necessary parameters',
  'Missing parameter: invoice_id' => 'Missing parameter: invoice_id',
  'Mobile Phone Number' => 'Mobile Phone Number',
  'Mobile Phone Number
Enter your Mobile Phone number in internation format
It will be used for SMS notifications' => 'Mobile Phone Number
Enter your Mobile Phone number in internation format
It will be used for SMS notifications',
  'Mode' => 'Mode',
  ...
  'NEVER' => 'NEVER',
  'NGINX Protection Rules' => 'NGINX Protection Rules',
  'Name' => 'Name',
  'Name
...
Send message only if user is subscribed to any newsletter from list',
  ...
  'No files uplaoded' => 'No files uplaoded',
...
Enable %sTelephone Number Identification (TNI)%s service',
  ...
  'Number of Rebills' => 'Number of Rebills',
...
',
  ...
  'Offer that will be displayed for user on cancellation
        You can use &#37;amount&#37; placeholder in text(this is amount of discount)
        ' => 'Offer that will be displayed for user on cancellation
        You can use &#37;amount&#37; placeholder in text(this is amount of discount)
        ',
  ...
  'Offline Payment Receipts Uploaded' => 'Offline Payment Receipts Uploaded',
...
a record on %saMember CP -> Protect Content -> Newsletters%s page',
  ...
  'One Time Password  has been sent to your %s: %s' => 'One Time Password  has been sent to your %s: %s',
  'Online' => 'Online',
  ...
  'Owner' => 'Owner',
  'PAAY 3DS Settings' => 'PAAY 3DS Settings',
  ...
  'Paddle issued a VAT refund of %1$s for invoice #%2$s.' => 'Paddle issued a VAT refund of %1$s for invoice #%2$s.',
...
you can enter any HTML here, it will be displayed to customer when he chooses to pay using this payment system you can use the following tags: %s - Receipt HTML, %s - Invoice Title, %s - Invoice Id, %s - Invoice Total',
  'Payment Instructions for customer
you can enter any HTML here, it will be displayed to customer when he chooses to pay using this payment system you can use the following tags: %s - Receipt HTML, %s - Invoice Title, %s - Invoice Id, %s - Invoice Total, %s - Bank Name, %s - Virtual Account' => 'Payment Instructions for customer
you can enter any HTML here, it will be displayed to customer when he chooses to pay using this payment system you can use the following tags: %s - Receipt HTML, %s - Invoice Title, %s - Invoice Id, %s - Invoice Total, %s - Bank Name, %s - Virtual Account',
  'Payment Instructions for customer
you can enter any HTML here, it will be displayed to customer when he chooses to pay using this payment system you can use the following tags: %s - Receipt HTML, %s - Invoice Title, %s - Invoice Id, %s - Invoice Total, %s - Consumer Number/Voucher Code' => 'Payment Instructions for customer
you can enter any HTML here, it will be displayed to customer when he chooses to pay using this payment system you can use the following tags: %s - Receipt HTML, %s - Invoice Title, %s - Invoice Id, %s - Invoice Total, %s - Consumer Number/Voucher Code',
...
keep empty to report all',
  ...
  'Payment form is loading. Please wait' => 'Payment form is loading. Please wait',
  'Payment info' => 'Payment info',
  'Payment intent is empty' => 'Payment intent is empty',
  'Payment method is empty' => 'Payment method is empty',
  'Payment refund' => 'Payment refund',
  'Payment system doesn\'t support trial periods or coupons' => 'Payment system doesn\'t support trial periods or coupons',
  'Payments' => 'Payments',
  ...
  'Payments by signup form breakdown' => 'Payments by signup form breakdown',
...
when sale will be added to notification,
 default is to add all sales from past 2 hours',
  ...
  'Permalink' => 'Permalink',
  'Permission denied. You can\'t access this section' => 'Permission denied. You can\'t access this section',
...
These files will be available for downloads only for this user on his dashboard',
  ...
  'Please complete form below and click save' => 'Please complete form below and click save',
...
you still can signup again as new user.',
  ...
  'Please select' => 'Please select',
  'Please select  category for listing' => 'Please select  category for listing',
  ...
  'Please select product below and purchase more credits' => 'Please select product below and purchase more credits',
  'Please select the biller and click button to continue' => 'Please select the biller and click button to continue',
  'Please specify at least one serial code' => 'Please specify at least one serial code',
  ...
  'Please use only digits' => 'Please use only digits',
  ...
  'Please wait %s seconds' => 'Please wait %s seconds',
...
value required',
  ...
  'Plugin doesn\'t allow to change rebill date' => 'Plugin doesn\'t allow to change rebill date',
  ...
  'Preload Request response body is empty' => 'Preload Request response body is empty',
  'Preload Request response is not success. Got an error: %s' => 'Preload Request response is not success. Got an error: %s',
...
displayed on the shopping cart page',
  ...
  'Product ID
        Create special product to handle payments from aMember
        and specify product id there' => 'Product ID
        Create special product to handle payments from aMember
        and specify product id there',
...
keep empty to report all categories',
  'Product purchased: %s%s' => 'Product purchased: %s%s',
...
set it if you want to grant lifetime access to this item for users with active subscription on this date',
  'Publish Period End
set it if you want to grant lifetime access to this item for users with active subscription during selected period' => 'Publish Period End
set it if you want to grant lifetime access to this item for users with active subscription during selected period',
  'Publish Period Start
set it if you want to grant lifetime access to this item for users with active subscription during selected period' => 'Publish Period Start
set it if you want to grant lifetime access to this item for users with active subscription during selected period',
  'Published' => 'Published',
  'Purchase' => 'Purchase',
...
User should give correct answer to proof he is human and continue signup' => 'Questions with possible answers
one question per line
question and answers should be
separated by pipe, for example
Question1?|Answer1|Answer2|Answer3
...
User should give correct answer to proof he is human and continue signup',
  'Queue' => 'Queue',
...
By default the service uses the highest level available',
  'Requested quantity is too high' => 'Requested quantity is too high',
  ...
  'Require OTP for all users
            by default OTP will not be required on login so
            user will need to enable this in account' => 'Require OTP for all users
            by default OTP will not be required on login so
            user will need to enable this in account',
  'Required' => 'Required',
...
user must fill in these fields in order to pucrhase product',
  ...
  'Required. Use only digits' => 'Required. Use only digits',
  'Resellers-only page' => 'Resellers-only page',
  'Resend Code attempts limit was reached' => 'Resend Code attempts limit was reached',
  'Resend Postback
...
leave empty to reset for all users',
  ...
  'Response status code is not success: %s' => 'Response status code is not success: %s',
...
Terms will be changed by cron once an hour',
  ...
  'Secret key' => 'Secret key',
  'Secure Hash Key' => 'Secure Hash Key',
  ...
  'Select saved card' => 'Select saved card',
  ...
  'Self-Service Credit' => 'Self-Service Credit',
  'Self-Service Debit' => 'Self-Service Debit',
  'Self-Service Store' => 'Self-Service Store',
  'Seller has sent this item' => 'Seller has sent this item',
...
available in the member area for customers',
  ...
  'Session id is empty in request' => 'Session id is empty in request',
  'Set Cookie with Http Only flag' => 'Set Cookie with Http Only flag',
...
Unique Shop ID in the system',
  ...
  'Show' => 'Show',
  'Show "Newly Added" sign for product in cart' => 'Show "Newly Added" sign for product in cart',
...
If checked, the plugin will add a column to the Manage Products grid',
  ...
  'Show existing payment methods select
if existing Stripe customer will try to signup plugin will offer to pay using payment method already registered' => 'Show existing payment methods select
if existing Stripe customer will try to signup plugin will offer to pay using payment method already registered',
...
keep empty to report all',
  ...
  'Signup Forms
keep empty to report all' => 'Signup Forms
keep empty to report all',
  'Signup IP' => 'Signup IP',
...
use this options if you have column headers in first line of CSV file',
  'Skip Product Period
        do not show product period in Shopping, show only price' => 'Skip Product Period
...
in case of user already have access to this product',
  ...
  'Sort code' => 'Sort code',
  'Source
            imported subscriptions will be associated with that source
            ' => 'Source
            imported subscriptions will be associated with that source
            ',
  'Source Code &mdash; Copy/Paste Into Your Website' => 'Source Code &mdash; Copy/Paste Into Your Website',
  'Space' => 'Space',
  'Spam Protection (Random Questions)' => 'Spam Protection (Random Questions)',
...
0-255',
  ...
  'StackPath storage is not configured' => 'StackPath storage is not configured',
...
(keep empty for non-reseller products)',
  ...
  'Subusers Parent Email' => 'Subusers Parent Email',
  ...
  'Such rebill_times parameter  is not supported' => 'Such rebill_times parameter  is not supported',
...
This text will be included at bottom to PDF file. You can use all user specific placeholders here eg. %user.login%, %user.name_f%, %user.name_l% etc.',
  ...
  'The user name or password is incorrect. Login with %sOne Time Password%s' => 'The user name or password is incorrect. Login with %sOne Time Password%s',
  ...
  'There is no user with such username' => 'There is no user with such username',
  ...
  'This functionality will work only if you set up to access the CCBill Data Link Extract System.' => 'This functionality will work only if you set up to access the CCBill Data Link Extract System.',
...
To make form multi-page, insert \'Form Page Break\' item into the place where you want page to be split.',
  ...
  'Token is empty in incoming request' => 'Token is empty in incoming request',
  ...
  'Tokenization Key
        ...
        ' => 'Tokenization Key
            For collect JS api
        ',
  'Tokenization Source Key' => 'Tokenization Source Key',
  'Tolerance
if user make purchase with coupon within configured number of days then consider him as invited' => 'Tolerance
if user make purchase with coupon within configured number of days then consider him as invited',
...
for recurring subscription aMember notify iDevAffiliate only about initial payment',
  ...
  'Transaction ID is missing in request' => 'Transaction ID is missing in request',
  ...
  'Transfer Credits to' => 'Transfer Credits to',
  'Transparent' => 'Transparent',
  'Trigger' => 'Trigger',
  'Try again' => 'Try again',
  'Trying to load foreign subuser' => 'Trying to load foreign subuser',
  'Tune/HasOffers Reports' => 'Tune/HasOffers Reports',
  'Twitch Subscirption
...
if user has paid subscirption to a channel',
  ...
  'Unable to cancel invoice' => 'Unable to cancel invoice',
  ...
  'Unable to find transaction' => 'Unable to find transaction',
  ...
  'Unable to send SMS message' => 'Unable to send SMS message',
  ...
  'Unable to send verification code. Transport is not configured' => 'Unable to send verification code. Transport is not configured',
  ...
  'Unable to verify request' => 'Unable to verify request',
  'Unable to void' => 'Unable to void',
  ...
  'Unknown result received' => 'Unknown result received',
  'Unlimited' => 'Unlimited',
...
Plugin will update your Infusion Contact with autogenerated username/password',
  ...
  'Updated' => 'Updated',
  'Upgrade' => 'Upgrade',
  'Upgrade Id is empty' => 'Upgrade Id is empty',
...
use custom host, user, password for %s database connectionUsually you can leave this unchecked',
  ...
  'Use only digits' => 'Use only digits',
  'Used' => 'Used',
...
agreement state will be recorded to invoice instead of user',
  'User should have/had access during exact period' => 'User should have/had access during exact period',
  ...
  'User with such username does not exists' => 'User with such username does not exists',
  ...
  'Username
it must be %d or more characters in length
may only contain letters, numbers, and underscores' => 'Username
it must be %d or more characters in length
may only contain letters, numbers, and underscores',
  'Username
...
Free invoices won\'t be validated still',
  ...
  'Venmo' => 'Venmo',
  'Verification Level
        To create a new verification level, go to the “Integrations” tab and click “Add new level”.
        Fill in all the required fields and select the necessary verification steps from the drop-down menus.
        Then press “Add" to have the level saved.' => 'Verification Level
        To create a new verification level, go to the “Integrations” tab and click “Add new level”.
        Fill in all the required fields and select the necessary verification steps from the drop-down menus.
        Then press “Add" to have the level saved.',
  'Verification Status' => 'Verification Status',
  'Verification Step' => 'Verification Step',
  'Verification code is wrong. Please %sstart over%s' => 'Verification code is wrong. Please %sstart over%s',
  'Verification code is wrong. Please try again' => 'Verification code is wrong. Please try again',
...
notify the following admins about new messages in this ticket',
  ...
  'We whould like to offer you a $%amount% discount if you decide to stay with our services!' => 'We whould like to offer you a $%amount% discount if you decide to stay with our services!',
...
(not to be confused with the Control Panel username)',
  ...
  'Widget' => 'Widget',
  'Windcave is unable to handle billing, free trial period is not supported' => 'Windcave is unable to handle billing, free trial period is not supported',
  'Windcave is unable to handle billing, period is not supported' => 'Windcave is unable to handle billing, period is not supported',
  'Windcave is unable to handle billing, second_period must be equal to first_period' => 'Windcave is unable to handle billing, second_period must be equal to first_period',
  'With Labels' => 'With Labels',
  'Write your comment...' => 'Write your comment...',
  'Write your reply...' => 'Write your reply...',
  'Wrong Checkout.com API 3 response' => 'Wrong Checkout.com API 3 response',
  'Wrong Otp adapter passed.' => 'Wrong Otp adapter passed.',
  ...
  'Wrong session status' => 'Wrong session status',
  ...
  'You are not allowed to change this transaction' => 'You are not allowed to change this transaction',
  ...
  'You can purchase only one item at a time' => 'You can purchase only one item at a time',
  ...
  'You can\'t access this chat' => 'You can\'t access this chat',
  'You can\'t edit this listing' => 'You can\'t edit this listing',
  'You can\'t purchase own item' => 'You can\'t purchase own item',
  'You can\'t purchase this item!' => 'You can\'t purchase this item!',
  'You can\'t resend code' => 'You can\'t resend code',
  'You can\'t send credits to yourself' => 'You can\'t send credits to yourself',
  'You can\'t set listing quantity' => 'You can\'t set listing quantity',
  ...
  'You do not have enough credits to finish purchase' => 'You do not have enough credits to finish purchase',
  'You don\'t have enough credits in order to purchase this item' => 'You don\'t have enough credits in order to purchase this item',
  ...
  'You have %s credits that could be transferred  to another user' => 'You have %s credits that could be transferred  to another user',
  ...
  'You have no credits to transfer' => 'You have no credits to transfer',
  ...
  'Your "%s" pending invoices' => 'Your "%s" pending invoices',
  'Your %s Balance: ' => 'Your %s Balance: ',
  'Your %site_title% PIN code is %code%' => 'Your %site_title% PIN code is %code%',
...
Your account is \'example\'',
  ...
  'Your account require additional authentication factor' => 'Your account require additional authentication factor',
  ...
  'Your content  should not be public.
            ...
            content on Contabo.' => 'Your content  should not be public.
            Please restrict public access to your files
            and ensure you can not access it directly from Contabo.
            aMember use Access Key and Secret Key to generate links with
            authentication token for users to provide access them to your
  ...
  'Your content  should not be public.
            ...
            aMember use Access Key and Secret Key to generate links with
            authentication token for users to provide access them to your
            content on StackPath.' => 'Your content  should not be public.
            Please restrict public access to your files
            and ensure you can not access it directly from StackPath.
            aMember use Access Key and Secret Key to generate links with
            authentication token for users to provide access them to your
  ...
  'Your invite limit is over. You can do another invites later' => 'Your invite limit is over. You can do another invites later',
  'Your mobile phone is not verified, click %sthis link %s to verify your mobile phone' => 'Your mobile phone is not verified, click %sthis link %s to verify your mobile phone',
...
',
  ...
  'browse' => 'browse',
  'buy-credits-form' => 'buy-credits-form',
  'cancel' => 'cancel',
...
if 0 - without limit',
  ...
  'has any of values selected' => 'has any of values selected',
  ...
  'login' => 'login',
  'login with your Discord account' => 'login with your Discord account',
  'manage' => 'manage',
  'min' => 'min',
  'month' => 'month',
  'more than' => 'more than',
  ...
  'number of active users per product category' => 'number of active users per product category',
...
For example this IP is incorrect: 127.000.000.001',
  'share same signup IP with other users' => 'share same signup IP with other users',
  'showing %s record' => 'showing %s record',
