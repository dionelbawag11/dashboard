"object" == typeof navigator &&
  (function (e, t) {
      ...
      ee = t(function (e) {
        ...
        (e.exports = function (e, t, a, o) {
          var s = !!o && !!o.unsafe,
            ...
            c = !!o && !!o.noTargetGet;
          "function" == typeof a &&
            ("string" != typeof t || b(a, "name") || O(a, "name", t),
    ...
    gt.prototype[ft] || O(gt.prototype, ft, gt.prototype.valueOf),
      nt(gt, "Symbol"),
      (W[ht] = !0);
    var Ft = C.f,
      qt = i.Symbol;
        ...
        if (
          (g &&
            ...
            Pn !== Object.prototype &&
              s.next &&
              (yn(s) !== Pn &&
                (An ? An(s, Pn) : "function" != typeof s[Cn] && O(s, Cn, On)),
              nt(s, h, !0))),
          "values" == r &&
            p &&
            "values" !== p.name &&
    ...
    Oi("search", 1, function (e, t, n) {
      return [
        ...
        function (e) {
          ...
          var s = ji(r, a);
          return (
            Di(r.lastIndex, o) || (r.lastIndex = o), null === s ? -1 : s.index
          );
        },
      ];
    });
      ...
      lr =
        ...
        r(function () {
          ...
          return (
            ...
            7 != or({}, e)[n] ||
              "abcdefghijklmnopqrst" != Me(or({}, t)).join("")
          );
        })
          ? function (e, t) {
              for (
                var n = Re(e), i = arguments.length, r = 1, o = be.f, s = l.f;
                i > r;
          ...
          if (g(c))
            if ("function" == typeof (e = pr(c)))
              for (n = (t = e.call(c)).next; !(i = n.call(t)).done; ) {
                if (
                  (o = (a = (r = Ar(P(i.value))).next).call(r)).done ||
                  (s = a.call(r)).done ||
                  !a.call(r).done
                )
    ...
    Er(
      Kr,
      {
        ...
        delete: function (e) {
          ...
          for (
            var t = Ir(this), n = t.entries, i = e + "", r = 0;
            r < n.length;
        ...
        getAll: function (e) {
          Vr(arguments.length, 1);
          for (
            var t = Ir(this).entries, n = e + "", i = [], r = 0;
            r < t.length;
            r++
          )
                ...
                arguments.length > 1 &&
                  ...
                  g(t) &&
                    ...
                    "URLSearchParams" === ni(n) &&
                      ((i = t.headers ? new xr(t.headers) : new xr()).has(
                        "content-type"
                      ) ||
                        i.set(
                          "content-type",
            ...
            case za:
              if (((e.scheme = "file"), "/" == a || "\\" == a)) c = Wa;
                ...
                if (a == $r)
                  ...
                  if ("#" != a) {
                    Ca(r.slice(u).join("")) ||
                      ((e.host = i.host), (e.path = i.path.slice()), Oa(e)),
                      (c = Ya);
                    continue;
                  }
                  (e.host = i.host),
    ...
    var Ls = {
        getConstructor: function (e, t, n, i) {
          var r = e(function (e, a) {
              ar(e, r, t),
                Ss(e, { type: t, id: xs++, frozen: void 0 }),
                null != a && ks(a, e[i], e, n);
            }),
            a = Es(t),
            o = function (e, t, n) {
      ...
      Ie(
        { target: "Object", stat: !0, sham: !a },
        {
          getOwnPropertyDescriptors: function (e) {
            for (
              var t, n, i = m(e), r = A.f, a = we(i), o = {}, s = 0;
              a.length > s;
    ...
    var il = function (e) {
      ...
      ml = function (e) {
        return (
          al(e) ||
          ((sl(e) || ll(e) || cl(e)) && !e.length) ||
          (ol(e) && !Object.keys(e).length)
        );
      };
    function gl(e, t) {
      if (1 > t) {
      ...
      wl = (function () {
        function e(t, n) {
          (function (e, t) {
            ...
            dl(t)
              ? (this.element = t)
              : ul(t) && (this.element = document.querySelector(t)),
            dl(this.element) &&
              ml(this.element.rangeTouch) &&
              ((this.config = el({}, tl, {}, n)), this.init());
        }
        return (
          (function (e, t, n) {
    ...
    (Pl && xl) ||
      ...
      "process" == h(Cl)
        ...
        : Ol && !El
        ? ((bl = (yl = new Ol()).port2),
          (yl.port1.onmessage = Ml),
          (vl = rt(bl.postMessage, bl, 1)))
        : !i.addEventListener ||
    ...
    var ec,
      ...
      Ec = Ce(hc, function () {
        ...
        return (
          ((e.constructor = {})[uc] = t), !(e.then(function () {}) instanceof t)
        );
      }),
      Ac =
        Ec ||
      ...
      Cc = function (e, t, n) {
        var r, a;
        Sc
          ? (((r = vc.createEvent("Event")).promise = t),
            (r.reason = n),
            r.initEvent(e, !1, !0),
            i.dispatchEvent(r))
      ...
      Oc = function (e, t) {
        cc.call(i, function () {
          ...
          if (
            ...
            ((n = lc(function () {
              Tc
                ? yc.emit("unhandledRejection", i, e)
                : Cc("unhandledrejection", e, i);
            })),
      ...
      Lc = function (e, t) {
        cc.call(i, function () {
          Tc
            ? yc.emit("rejectionHandled", e)
            : Cc("rejectionhandled", e, t.value);
        });
      },
      jc = function (e, t, n, i) {
        return function (r) {
    ...
    Ec &&
      ...
      (tc = function () {
        var e = new ec(),
          t = fc(e);
        (this.promise = e),
          (this.resolve = jc(Rc, e, t)),
          (this.reject = jc(Nc, e, t));
      }),
      (oc.f = wc =
        function (e) {
    ...
    var Mc,
      ...
      Fc = ys("startsWith"),
      qc = !(
        Fc || ((Mc = _c(String.prototype, "startsWith")), !Mc || Mc.writable)
      );
    Ie(
      { target: "String", proto: !0, forced: !qc && !Fc },
      {
        startsWith: function (e) {
          ...
          gs(e);
          var n = le(
              Dc(arguments.length > 1 ? arguments[1] : void 0, t.length)
            ),
            i = String(e);
    ...
    function xu(e) {
      ou(e) || au(e)
        ? Array.from(e).forEach(xu)
        : su(e) && su(e.parentNode) && e.parentNode.removeChild(e);
    }
    function Cu(e) {
      if (su(e))
    ...
    function Ou(e, t) {
      return su(t) && su(t.parentNode) && su(e)
    ...
    var Du,
      ...
      qu = {
        ...
        pip: !(
          gu.isIPhone ||
          (!ru(Au("video").webkitSetPresentationMode) &&
            (!document.pictureInPictureEnabled ||
              Au("video").disablePictureInPicture))
        ),
        ...
        rangeInput:
          ((Du = document.createElement("input")),
          (Du.type = "range"),
          "range" === Du.type),
    ...
    function Yu() {
      ...
      return new Promise(function (t) {
        return e.ready
          ? setTimeout(t, 0)
          : Vu.call(e, e.elements.container, "ready", t);
      }).then(function () {});
    }
    function Gu(e) {
    ...
    function Xu(e) {
      return (
        !!(au(e) || (nu(e) && e.includes(":"))) &&
        (au(e) ? e : e.split(":")).map(Number).every(tu)
      );
    }
    function Qu(e) {
        ...
        if (this.isHTML5) {
          ...
          (e.options.speed = e.config.speed.options),
            ...
            Object.defineProperty(e.media, "quality", {
              ...
              set: function (t) {
                if (e.quality !== t) {
                  if (e.config.quality.forced && ru(e.config.quality.onChange))
    ...
    if (
      ...
      for (
        var fh = function (e, t) {
            ...
            uh
              ? r && !a && (e = e.source)
              : e instanceof fh && (a && (t = ri.call(e)), (e = e.source)),
              hh &&
                (n = !!t && t.indexOf("y") > -1) &&
                (t = t.replace(/y/g, ""));
    ...
    var jh = {
      getIconUrl: function () {
        var e =
          ...
          (gu.isIE && !window.svg4everybody);
        return { url: this.config.iconUrl, cors: e };
      },
      findElements: function () {
        try {
          return (
            (this.elements.controls = _u.call(
              this,
            ...
            (this.elements.progress = _u.call(
              this,
      ...
      createBadge: function (e) {
        ...
        return (
          t.appendChild(
            Au("span", { class: this.config.classNames.menu.badge }, e)
          ),
          t
        );
      },
      createButton: function (e, t) {
        ...
        return (
          a.toggle
            ? (o.appendChild(
                jh.createIcon.call(this, a.iconPressed, {
                  class: "icon--pressed",
                })
              ),
              o.appendChild(
                jh.createIcon.call(this, a.icon, { class: "icon--not-pressed" })
              ),
              o.appendChild(
                jh.createLabel.call(this, a.labelPressed, {
                  class: "label--pressed",
                })
              ),
              o.appendChild(
                jh.createLabel.call(this, a.label, {
          ...
          Eu(o, i),
          "play" === r
            ? (au(this.elements.buttons[r]) || (this.elements.buttons[r] = []),
      ...
      createRange: function (e, t) {
        ...
        return (
          ...
          jh.updateRangeFill.call(this, n),
          wl.setup(n),
          n
        );
      },
      createProgress: function (e, t) {
        var n = Au(
          "progress",
          Tu(
            Iu(this.config.selectors.display[e]),
            {
              min: 0,
              max: 100,
              value: 0,
          ...
          function (i) {
            if (
              ...
              if (!a && [32, 39].includes(i.which))
                jh.showMenuPanel.call(n, t, !0);
              else
                32 !== i.which &&
                  (40 === i.which || (a && 39 === i.which)
                    ? ((r = e.nextElementSibling),
                      su(r) || (r = e.parentNode.firstElementChild))
                    : ((r = e.previousElementSibling),
                      su(r) || (r = e.parentNode.lastElementChild)),
                  Uu.call(n, r, !0));
            }
          },
          !1
      ...
      updateVolume: function () {
        this.supported.ui &&
          (su(this.elements.inputs.volume) &&
            jh.setRange.call(
              this,
              this.elements.inputs.volume,
              this.muted ? 0 : this.volume
            ),
          su(this.elements.buttons.mute) &&
            ...
            switch (e.type) {
              ...
              case "seeked":
                (n = (function (e, t) {
                  ...
                  "timeupdate" === e.type &&
                    jh.setRange.call(this, this.elements.inputs.seek, n);
                break;
              case "playing":
              case "progress":
                !(function (e, n) {
      ...
      updateSeekTooltip: function (e) {
        ...
        if (
          ...
          su(this.elements.inputs.seek) &&
          su(this.elements.display.seekTooltip) &&
          0 !== this.duration
        ) {
      ...
      durationUpdate: function () {
        if (
          ...
          if (this.duration >= Math.pow(2, 32))
            return (
              Lu(this.elements.display.currentTime, !0),
              void Lu(this.elements.progress, !0)
            );
          su(this.elements.inputs.seek) &&
      ...
      updateSetting: function (e, t, n) {
        ...
        if ("captions" === e) r = this.currentTrack;
          ...
          if (
            ((r = du(n) ? this[e] : n),
            du(r) && (r = this.config[e].default),
            !du(this.options[e]) && !this.options[e].includes(r))
          )
        ...
        if ((su(a) || (a = i && i.querySelector('[role="menu"]')), su(a))) {
          ...
          ).innerHTML = jh.getLabel.call(this, e, r);
      ...
      setQualityMenu: function (e) {
        ...
        if (su(this.elements.settings.panels.quality)) {
          ...
          if (
            (jh.toggleMenuButton.call(this, "quality", i),
            Cu(n),
      ...
      setCaptionsMenu: function () {
        ...
        if (su(this.elements.settings.panels.captions)) {
          var t =
            ...
            i = Boolean(n.length);
          if (
            (jh.toggleMenuButton.call(this, "captions", i),
            Cu(t),
            jh.checkMenu.call(this),
            i)
          ) {
            var r = n.map(function (n, i) {
              return {
                ...
                badge:
                  n.language &&
                  jh.createBadge.call(e, n.language.toUpperCase()),
                list: t,
                type: "language",
              };
            });
      ...
      toggleMenu: function (e) {
        ...
        if (su(t) && su(n)) {
          ...
          n.setAttribute("aria-expanded", r),
            ...
            r && cu(e)
              ? jh.focusFirstMenuItem.call(this, null, !0)
              : r || i || Uu.call(this, n, cu(e));
        }
      },
      ...
      create: function (e) {
        ...
        return (
          th(au(this.config.controls) ? this.config.controls : []).forEach(
            function (s) {
              if (
                ...
                if (
                  ...
                  p.appendChild(
                    a.call(
                      t,
                      "volume",
                      Tu(m, { id: "plyr-volume-".concat(e.id) })
                    )
                  );
                }
              }
              if (
                ...
                "settings" === s && !du(t.config.settings))
              ) {
                var g = Au(
                  "div",
                  Tu({}, h, {
                ...
                b.appendChild(w),
                  ...
                  t.config.settings.forEach(function (i) {
                    ...
                    l.appendChild(
                      Au("span", { "aria-hidden": !0 }, Th(i, t.config))
                    ),
                      l.appendChild(
                        Au(
                          "span",
                          { class: t.config.classNames.hidden },
                          Th("menuBack", t.config)
                        )
                      ),
                      Vu.call(
                        t,
      ...
      inject: function () {
        ...
        if (
          (r &&
            ...
            (n = a)),
          nu(this.config.selectors.controls.container) &&
            (o = document.querySelector(
              this.config.selectors.controls.container
            )),
          su(o) || (o = this.elements.container),
          o[su(n) ? "insertAdjacentElement" : "insertAdjacentHTML"](
            "afterbegin",
            n
          ),
        ...
        if ((gu.isEdge && mu(o), this.config.tooltips.controls)) {
          ...
          Array.from(f).forEach(function (t) {
            ju(t, e.config.classNames.hidden, !1),
              ju(t, e.config.classNames.tooltip, !0);
          });
        }
      },
    };
            ...
            if (
              ...
              if (
                (su(this.elements.captions) ||
                  ((this.elements.captions = Au(
                    "div",
                    Iu(this.config.selectors.captions)
                  )),
                  (function (e, t) {
                    su(e) &&
                      su(t) &&
        ...
        update: function () {
          ...
          this.isHTML5 &&
            ...
            ((s && this.language !== r) || !t.includes(o)) &&
              (Mh.setLanguage.call(this, r), Mh.toggle.call(this, i && s)),
            ju(
                ...
                var o = Mh.getTracks.call(this),
                  s = Mh.findTrack.call(
                    ...
                    [this.captions.language].concat(
                      Po(this.captions.languages)
                    ),
                    !0
                  );
                return (
                  (this.captions.language = s.language),
                  void Mh.set.call(this, o.indexOf(s))
                );
              }
          ...
          if (-1 !== e)
            if (tu(e))
              if (e in n) {
                ...
                Mh.toggle.call(this, !0, t),
                  this.isHTML5 && this.isVideo && Mh.updateCues.call(this);
        ...
        getLabel: function (e) {
          ...
          return (
            !uu(t) &&
              ...
              (t = Mh.getCurrentTrack.call(this)),
            uu(t)
              ? du(t.label)
                ? du(t.language)
              ...
              if (Zc(e) || Array.isArray(e)) {
                ...
                if (i !== this.elements.captions.innerHTML) {
                  ...
                  (r.innerHTML = i),
                    ...
                    Ku.call(this, this.media, "cuechange");
                }
          ...
          wo(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  if (this.enabled)
                    if (gu.isIos && this.player.config.fullscreen.iosNative)
                ...
                get: function () {
                  ...
                  return (
                    ["webkit", "moz", "ms"].some(function (t) {
                      return (
                        !(
                          !ru(document["".concat(t, "ExitFullscreen")]) &&
                          !ru(document["".concat(t, "CancelFullScreen")])
                        ) && ((e = t), !0)
                      );
                    }),
                    e
    ...
    var $h = {
        ...
        build: function () {
          ...
          su(this.elements.controls) ||
            (jh.inject.call(this), this.listeners.controls()),
            ...
            ju(
              ...
              qu.pip && this.isHTML5 && this.isVideo
            ),
            ju(
              this.elements.container,
              this.config.classNames.airplay.supported,
              qu.airplay && this.isHTML5
            ),
            ...
            this.poster &&
              $h.setPoster.call(this, this.poster, !1).catch(function () {}),
          ...
          ju(
            ...
            Array.from(this.elements.buttons.play || []).forEach(function (e) {
              Object.assign(e, { pressed: t.playing }),
                e.setAttribute(
                  "aria-label",
                  Th(t.playing ? "pause" : "play", t.config)
                );
            }),
          ...
          wo(e, [
                ...
                if (
                  ...
                  if (r) {
                    ...
                    if (su(o)) {
                      ...
                      if (32 === e.which && Ru(o, 'button, [role^="menuitem"]'))
                        return;
                    }
                    switch (
                      ([
            ...
            },
            {
              ...
              value: function () {
                var e = this.player,
                  t = e.elements;
                (e.touch = !0),
                  ju(t.container, e.config.classNames.isTouch, !0);
              },
            },
            {
              key: "setTabFocus",
            ...
            },
            {
              ...
              value: function () {
                ...
                t.config.keyboard.global &&
                  Bu.call(t, window, "keydown keyup", this.handleKey, e, !1),
            ...
            },
            {
              ...
              value: function () {
                ...
                !t.keyboard.global &&
                  t.keyboard.focused &&
                  Vu.call(e, n.container, "keydown keyup", this.handleKey, !1),
                  Vu.call(
                    e,
                    n.container,
                  ...
                  function (t) {
                    ...
                    if (
                      ...
                      !(function (t, n, i) {
                        ...
                        s ||
                          (l
                            ? Vu.call(e, window, "resize", a)
                            : zu.call(e, window, "resize", a));
                    }
                  }
                );
              },
              ...
              value: function () {
                ...
                Vu.call(t, t.media, r, function (e) {
                  ...
                  "error" === e.type && (r = t.media.error),
                    Ku.call(t, n.container, e.type, !0, r);
                });
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.bind(
                  ...
                  gu.isWebkit &&
                    Array.from(Mu.call(t, 'input[type="range"]')).forEach(
                      function (n) {
    ...
    function tf(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e &&
          ((this.media.paused = !e),
          Ku.call(this, this.media, e ? "play" : "pause"));
    }
    var nf = {
      setup: function () {
        var e = this;
      ...
      ready: function () {
        ...
        Eh(gh(t.config.urls.vimeo.api, c), "json").then(function (e) {
          if (!du(e)) {
            ...
            (n.pathname = "".concat(n.pathname.split("_")[0], ".jpg")),
              $h.setPoster.call(t, n.href).catch(function () {});
          }
        }),
        ...
        Object.defineProperty(t.media, "loop", {
          ...
          t.embed.on("loaded", function () {
            ...
            su(t.embed.element) && t.supported.ui) &&
          ...
          t.embed.on("timeupdate", function (e) {
            (t.media.seeking = !1),
              (p = e.seconds),
              Ku.call(t, t.media, "timeupdate");
          }),
          t.embed.on("progress", function (e) {
            (t.media.buffered = e.percent),
              Ku.call(t, t.media, "progress"),
              1 === parseInt(e.percent, 10) &&
                Ku.call(t, t.media, "canplaythrough"),
              t.embed.getDuration().then(function (e) {
                e !== t.media.duration &&
                  ((t.media.duration = e),
                  Ku.call(t, t.media, "durationchange"));
              });
          }),
    ...
    var of = {
        setup: function () {
          var e = this;
          if (
            (ju(this.elements.wrapper, this.config.classNames.embed, !0),
            eu(window.YT) && ru(window.YT.Player))
          )
            of.ready.call(this);
          else {
              ...
              events: {
                  ...
                  if (!ru(e.media.play)) {
                    ...
                    Object.defineProperty(e.media, "volume", {
                      ...
                      set: function (t) {
                        (i = t),
                          n.setVolume(100 * i),
                          Ku.call(e, e.media, "volumechange");
                      },
                    });
                      ...
                      (e.timers.buffering = setInterval(function () {
                        (e.media.buffered = n.getVideoLoadedFraction()),
                          (null === e.media.lastBuffered ||
                            ...
                            Ku.call(e, e.media, "progress"),
                          (e.media.lastBuffered = e.media.buffered),
                          1 === e.media.buffered &&
                            (clearInterval(e.timers.buffering),
                            Ku.call(e, e.media, "canplaythrough"));
                      }, 200)),
                      setTimeout(function () {
                ...
                onStateChange: function (t) {
                  ...
                  switch (
                    ...
                    e.media.seeking &&
                      [1, 2].includes(t.data) &&
                      ((e.media.seeking = !1), Ku.call(e, e.media, "seeked")),
                    t.data)
                  ) {
                    case -1:
                      Ku.call(e, e.media, "timeupdate"),
        ...
        setup: function () {
          this.media
            ? (ju(
              ...
              this.isVideo &&
                ((this.elements.wrapper = Au("div", {
                  class: this.config.classNames.video,
                })),
                Su(this.media, this.elements.wrapper),
                (this.elements.poster = Au("div", {
              ...
              this.isHTML5
                ...
                : this.isYouTube
                ? of.setup.call(this)
                : this.isVimeo && nf.setup.call(this))
        ...
        return (
          wo(e, [
              ...
              value: function () {
                ...
                var n = function () {
                  var t = Lh(Math.max(e.manager.getRemainingTime(), 0)),
                    n = ""
                      .concat(Th("advertisement", e.player.config), " - ")
                      .concat(t);
            ...
            },
            {
              ...
              value: function (e, t) {
                return (
                  au(this.events[e]) || (this.events[e] = []),
        ...
        pf || !mf || !gf
          ? function (e) {
              ...
              var t = m(this),
                ...
                i = n - 1;
              for (
                arguments.length > 1 && (i = ff(i, oe(arguments[1]))),
                  i < 0 && (i = n + i);
                i >= 0;
                i--
              )
          ...
          : df;
    Ie(
      { target: "Array", proto: !0, forced: vf !== [].lastIndexOf },
      { lastIndexOf: vf }
    );
    var yf = function (e, t) {
        var n = {};
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.elements.thumb.time = Au("span", {}, "00:00")),
                  ...
                  su(this.player.elements.progress) &&
                ...
                function () {
                  ...
                  Object.assign(t, {
                    ...
                    t.isHTML5 &&
                      ...
                      wf.insertElements.call(t, "track", e.tracks),
              ...
              if (qu.check().api) {
                ...
                switch (a) {
                  case "div":
                    ...
                    if (
                      du(this.provider) ||
                      !Object.keys(Fh).includes(this.provider)
                    )
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      su(this.elements.container) ||
                        ((this.elements.container = Au("div", { tabindex: 0 })),
                        Su(this.media, this.elements.container)),
                      ...
                      this.config.previewThumbnails.enabled &&
                        (this.previewThumbnails = new bf(this)))
          ...
          wo(
            ...
            [
              ...
              },
              {
                key: "pause",
                value: function () {
                  return this.playing && ru(this.media.pause)
                    ? this.media.pause()
                    : null;
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  this.isHTML5
                    ...
                    : ru(this.media.stop) && this.media.stop();
                },
              },
              {
                key: "restart",
              ...
              },
              {
                ...
                set: function (e) {
                  var t = this,
                    n = null;
                  tu(e) && (n = e),
                    tu(n) || (n = this.storage.get("speed")),
                    tu(n) || (n = this.config.speed.selected);
              ...
              },
              {
                ...
                get: function () {
                  return this.isYouTube
                    ? Math.min.apply(Math, Po(this.options.speed))
                    : this.isVimeo
                    ? 0.5
                    : 0.0625;
                },
              },
              {
                ...
                get: function () {
                  return this.isYouTube
                    ? Math.max.apply(Math, Po(this.options.speed))
                    : this.isVimeo
                    ? 2
                    : 16;
                },
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? $h.setPoster.call(this, e, !1).catch(function () {})
              ...
              },
              {
                ...
                set: function (e) {
                  if (qu.pip) {
                    ...
                    ru(this.media.webkitSetPresentationMode) &&
                      this.media.webkitSetPresentationMode(t ? Uh : Dh),
