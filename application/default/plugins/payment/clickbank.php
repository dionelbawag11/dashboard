...
class Am_Paysystem_Clickbank extends Am_Paysystem_Abstract
{
    ...
    public function __construct(Am_Di $di, array $config, $id = false)
    {
        ...
        $di->billingPlanTable->customFields()->add(
            ...
            'ClickBank Product#',
            'you have to create similar product in ClickBank and enter its number here',
            'required', ['options' => ['' => '-- Please select --', '11' => '#11', '22' => '#22']])*/
        );
        $di->billingPlanTable->customFields()->add(
            new Am_CustomFieldText(
            'clickbank_skin_id',
    ...
    {
        parent::init();
        $this->getDi()->blocks->add('thanks/success', new Am_Block_Base('ClickBank Statement', 'clickbank-statement', $this, [$this, 'renederStatement']));
    }
