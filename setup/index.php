...
function check_versions()
{
    if( version_compare(phpversion(), '7.4') < 0)
        die("PHP version 7.4 or greater is required to run aMember. Your PHP-Version is : ".phpversion().
...
class SetupController
{
    ...
    function check_for_writeable()
    {
        ...
        foreach(["$root_dir/data/",
            ...
            if (!is_writeable($d))
                $this->addError("Directory '$d' is not writable. Please <a href='https://www.amember.com/docs/Setting_Permission_for_a_File_or_a_Folder' target='_blank'>fix it</a>");
        }
        return !$this->errors;
    }
    ...
    function checkHtaccess()
    {
        ...
        if (!is_writable($htaccess))
        {
            ...
            $this->fatal(
                ...
                "or Web-hosting control panel file manager to update this file \n".
...
<p>Internet Expolorer sometimes rename files when save it. For example, it may rename <i>config.php</i> to <i>config[1].php</i>. Don't forget to  fix it before uploading!
<p>
<script>
    function copyc(){
...
<p>You can find  the aMember Pro User's Guide <a href='https://www.amember.com/docs/Main_Page'>here</a>.
        ...
        <div class="am-footer">
            <div class="am-footer-content-wrapper am-main">
                <div class="am-footer-content">
                    aMember Pro&trade; 6.3.20 by <a href="https://www.amember.com">aMember.com</a>  &copy; 2002&ndash;$year CGI-Central.Net
                </div>
            </div>
        </div>
    </body>
