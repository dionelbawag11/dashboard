...
class UploadTable extends Am_Table_WithData
{
    ...
    public function init()
    {
        ...
        $this->defineUsage('emailtemplate', 'email_template', 'attachments', UploadTable::STORE_IMPLODE, "Email Template [%name%, %lang%]", '/admin-setup/email-template');
        $this->defineUsage('email-pending', 'email_template', 'attachments', UploadTable::STORE_IMPLODE, "Pending Notification Template [%email_template_id%]", '/admin-setup/email-template');
    ...
    function cleanUp()
    {
        ...
        foreach ($this->findByDelete($time) as $upload)
        {
            try {
                ...
                $this->getDi()->logger->error("Could not delete upload during cleanup {$upload->upload_id}", ["exception" => $e]);
            }
        }
    }
