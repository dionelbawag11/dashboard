...
class Product extends Am_Record_WithData implements IProduct
{
    ...
    {
        return htmlspecialchars(strip_tags($string), ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401, 'UTF-8', false);
    }
    ...
    public function insert($reload = true)
    {
        ...
        $this->getDi()->hook->call(Am_Event::PRODUCT_AFTER_INSERT, ['product' => $this]);
        return $_;
    }

    function update()
    {
        if ($this->getDi()->hook->have(Am_Event::PRODUCT_AFTER_UPDATE)) {
            $oldProduct = $this->getDi()->productTable->load($this->pk());
        }

        $ret = parent::update();

        if ($this->getDi()->hook->have(Am_Event::PRODUCT_AFTER_UPDATE)) {
            $this->getDi()->hook->call(new Am_Event(Am_Event::PRODUCT_AFTER_UPDATE, [
                'product' => $this,
    ...
    public function setStartDate(array $setting = null)
    {
...
class ProductTable extends Am_Table_WithData
{
     ...
     */
    function getVisible($productCategories = null, $activeProductIds = null, $expiredProductIds = null)
    {
