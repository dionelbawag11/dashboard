...
class Am_Grid_Action_Group_SavedFormToggle extends Am_Grid_Action_Group_Abstract
{
    ...
    public function __construct($enable = true)
    {
        ...
        parent::__construct(
            $enable ? "saved-form-enable" : "saved-form-disable",
...
class Am_Grid_Action_Group_SavedFormDelete extends Am_Grid_Action_Group_Delete
{
    public function handleRecord($id, $record)
    {
        if ($record->canDelete()) {
            return parent::handleRecord($id, $record);
        }
    }
}
...
CUT;
        ...
        $grid->actionAdd(new Am_Grid_Action_Group_SavedFormToggle(false));
        $grid->actionAdd(new Am_Grid_Action_Group_SavedFormToggle(true));
        $grid->actionAdd(new Am_Grid_Action_Group_SavedFormDelete);
