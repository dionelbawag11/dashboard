...
class Am_Form extends HTML_QuickForm2
{
     ...
     * so groups contains html of containing elements
     * @param array $arr
     */
...
HTML_QuickForm2_Factory::registerElement('number', 'Am_Form_Element_InputNumber');
...
class Am_Form_Element_Integer extends HTML_QuickForm2_Element_Input
{
    ...
    public function __construct($name = null, $attributes = null, $data = null)
    {
        ...
        $this->addRule('regex', ___('Integer value required'), '/^\d+$/');
    }
}

class Am_Form_Element_InputNumber extends HTML_QuickForm2_Element_Input
{
...
class Am_Form_Element_Date extends HTML_QuickForm2_Element_InputText
{
    ...
    {
        $_ = parent::getValue();
        return is_null($_) ? $_ : self::convertReadableToSQL($_);
    }

    /**
     * @param string $date date in Readable format
     * @return mixed (string|false) date in SQL format, empty string, false - string is incorrect
     */
